...
module TypeScript {
    ...
    export class AstWalkerFactory {
        ...
        private initChildrenWalkers(): void {
            ...
            this.childrenWalkers[NodeType.Self] = ChildrenWalkers.walkNone;
            ...
            this.childrenWalkers[NodeType.Repeat] = ChildrenWalkers.walkDoWhileStatementChildren;
    ...
    module ChildrenWalkers {
        ...
        export function walkDoWhileStatementChildren(preAst: RepeatStatement, parent: AST, walker: IAstWalker): void {
            preAst.cond = walker.walk(preAst.cond, preAst);
            if (preAst.body && (walker.options.goNextSibling)) {
                preAst.body = walker.walk(preAst.body, preAst);
            }
