...
module TypeScript {
    ...
    export enum ErrorRecoverySet {
        ...
        Scope = 1 << 16, // Scope
        In = 1 << 17, // IN
        Do = 1 << 18, // CASE, DEFAULT
        Else = 1 << 19, // ELSE Elseif
        End = 1 << 20, // end
        Local = 1 << 21, // 
        Stmt = 1 << 22, // BREAK, RETURN, THROW, DEBUGGER, FOR, SWITCH, DO, IF, TRY, WITH (REPEAT)
        While = 1 << 23, // WHILE
        ID = 1 << 24, // ID
        ...
        ExprStart = SColon | AddOp | LCurly | PreOp | Then | LParen | LBrack | ID | Prefix | RLit | Func | Literal,
        StmtStart = ExprStart | SColon | Local | Stmt | While | TypeScriptS,
