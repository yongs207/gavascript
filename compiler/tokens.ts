...
module TypeScript {
    ...
    noRegexTable[TokenID.SELF] = true;
    ...
    setTokenInfo(TokenID.CONST, Reservation.TypeScriptAndJSFuture, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "const", ErrorRecoverySet.Local);
    ...
    setTokenInfo(TokenID.UNTIL, Reservation.TypeScriptAndJS, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "until", ErrorRecoverySet.Stmt);
    setTokenInfo(TokenID.END, Reservation.JavascriptFutureStrict, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "end", ErrorRecoverySet.None);
    ...
    setTokenInfo(TokenID.ELSEIF, Reservation.TypeScriptAndJS, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "elseif", ErrorRecoverySet.Stmt);
    ...
    setTokenInfo(TokenID.SELF, Reservation.TypeScriptAndJS, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "self", ErrorRecoverySet.RLit);
    ...
    setTokenInfo(TokenID.THEN, Reservation.TypeScriptAndJS, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "then", ErrorRecoverySet.Stmt);
    setTokenInfo(TokenID.LOCAL, Reservation.TypeScriptAndJS, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "local", ErrorRecoverySet.Local);
    ...
    setTokenInfo(TokenID.REPEAT, Reservation.TypeScriptAndJS, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "repeat", ErrorRecoverySet.While);
    ...
    setTokenInfo(TokenID.Regex, Reservation.None, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, "regex", ErrorRecoverySet.Then);
    ...
    setTokenInfo(TokenID.Comma, Reservation.None, OperatorPrecedence.No, NodeType.None, OperatorPrecedence.No, NodeType.None, ",", ErrorRecoverySet.Comma); // ,
    ...
    setTokenInfo(TokenID.AND, Reservation.None, OperatorPrecedence.Lan, NodeType.LogAnd, OperatorPrecedence.No, NodeType.None, "and", ErrorRecoverySet.BinOp);
    setTokenInfo(TokenID.OR, Reservation.None, OperatorPrecedence.Lor, NodeType.LogOr, OperatorPrecedence.No, NodeType.None, "or", ErrorRecoverySet.BinOp);
    setTokenInfo(TokenID.NOT, Reservation.None, OperatorPrecedence.No, NodeType.Not, OperatorPrecedence.No, NodeType.Not, "not", ErrorRecoverySet.PreOp);
